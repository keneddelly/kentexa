...
const EXPORT_COLUMNS: { key: keyof EarlyAccessRegistration; header: string }[] = [
  ...
  { key: 'coverageAreas', header: 'Coverage Areas (notes)' },
  { key: 'cargoCapacity', header: 'Cargo Capacity' },
  ...
  { key: 'pricingModel', header: 'Pricing Model' },
  ...
  { key: 'dailyCapacity', header: 'Daily Capacity' },
